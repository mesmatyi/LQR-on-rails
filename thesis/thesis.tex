...
%--------------------------------------------------------------------------------------
\newcommand{\szerzoVezeteknev}{Mesics}
\newcommand{\szerzoKeresztnev}{Mátyás}
\newcommand{\szerzoNeptun}{BWQ0KJ}
...
\newcommand{\cim}{OpenPilot keresztírányú szabályzó fejlesztése } % Cím
\newcommand{\tanszek}{\szeit} % informatika (\szeit), automatizálási (\szeaut) vagy távközlési (\szetat)
\newcommand{\doktipus}{\diplomaterv} % Dokumentum típusa (\szakdolgozat, \diplomaterv vagy \dolgozat)
